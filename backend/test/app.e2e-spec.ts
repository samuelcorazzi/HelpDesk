...
// Testes ponta a ponta com Prisma simulado: validam API, autenticação e permissões sem banco externo.
...
describe('API HelpDesk (ponta a ponta)', () => {
  ...
  beforeEach(async () => {
    // Cada teste recebe mocks novos para evitar que o estado de um afete o outro.
  ...
  afterEach(async () => {
    // Remove o eventual arquivo de teste e encerra a aplicação criada para o caso.
